## Delete Notes API Documentation

### Request

`POST https://localhost/api/[id]/notes/delete`
...
|-|-|
| 200 | Successful delete notes request |
| 400 | Unsuccessful request, request parameters does not fit requirements above |
| 401 | Unsuccessful request, JWT token invalid |
| 403 | Unsuccessful request, not authorised to delete notes controlled by another user |
