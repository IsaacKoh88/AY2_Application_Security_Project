## Edit Budget API Documentation

### Request

`POST https://localhost/api/[id]/budget/edit`
...
| budget | Number more than 0 |

### Response

| Response Status | Response Meaning |
|-|-|
| 201 | Successful edit budget request |
| 400 | Unsuccessful request, request parameters does not fit requirements above |
| 401 | Unsuccessful request, JWT token invalid |
| 403 | Unsuccessful request, not authorised to request change of budget data controlled by another user |
